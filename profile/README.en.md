...
<table>
  <tr>
    <td width="33%" valign="top">
      ...
      <p>Start with a small mechanic. Turn a wild idea into something people can actually play.</p>
    </td>
    <td width="33%" valign="top">
      <sub>02 / COMMUNITY</sub>
      <h3>Play. Share. Iterate.</h3>
      <p>Share demos and honest feedback. Give someone else a starting point to build on.</p>
    </td>
    <td width="33%" valign="top">
      <sub>03 / BUILD</sub>
      <h3>Build our own tools</h3>
      <p>Find the friction in making real games, then develop AI tools that make creating easier.</p>
    </td>
  </tr>
</table>
...
<p>
  <img src="../assets/process-en.svg" alt="Imagine → Create → Play → Keep going" width="100%" />
</p>
...
<p align="center">
  <b>Start with play. Stay open. Keep creating.</b><br />
  <sub>MAKE SOMETHING WORTH PLAYING.</sub>
</p>
