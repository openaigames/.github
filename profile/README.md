...
<p align="center">
  <img src="../assets/banner-openaigames.png" alt="OpenAIGames — Make something worth playing. 一起做点值得玩的。" width="100%" />
</p>
...
<table>
  <tr>
    <td width="33%" valign="top">
      <sub>01 / GAMES</sub>
      <h3>一起做游戏</h3>
      <p>从一个小玩法出发，把脑洞变成可以亲手体验的作品。</p>
    </td>
    <td width="33%" valign="top">
      <sub>02 / COMMUNITY</sub>
      <h3>一起玩，一起改</h3>
      <p>展示 Demo，交换真实反馈，让一个人的想法被更多人接着创造。</p>
    </td>
    <td width="33%" valign="top">
      <sub>03 / BUILD</sub>
      <h3>做自己的创作工具</h3>
      <p>从实际制作中发现问题，逐步研发让游戏创作更顺手的 AI 工具。</p>
    </td>
  </tr>
</table>
...
<p>
  <img src="../assets/process-v2.svg" alt="一个想法 → 一起制作 → 交换试玩 → 继续创造" width="100%" />
</p>
